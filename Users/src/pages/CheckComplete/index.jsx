         ...
         <Col span={24} style={{ margin:"0 auto",background:"#f0f0f0", height:"400px"}}>
            <Row>
               <Col span={24} style={{display:"flex", justifyContent:"center", alignItems:"center", paddingTop:"100px"}}>
                  ...
                  <img style={{margin:"auto", alignItems:"center", cursor:"pointer"}} onClick={()=>{history.push('/checkout/check-history')}} src="https://img.icons8.com/dusk/128/000000/payment-history.png"/>
                  </div>
                     {/* <Button type="button" 
