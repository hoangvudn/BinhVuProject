      ...
      <Row>
         <Col span={24} className="header-container">
            <nav className="header-content nav">
               ...
               <div className="account-dropdown nav-dropdown">
               <div className="account-person nav-dropdown__account" onClick={() => handleShowSign()}>
                  ...
                  <span className="account-name nav-dropdown__account-name">
