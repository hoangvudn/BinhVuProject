...
function TourTravel({
   ...
   // console.warn("tourDetail.startDays[0]", tourDetail.startDays[0]);
   // console.log("tourDetail--tourDetail--start: ",tourDetail.start );
   useEffect(() => {
      setStartDay(tourDetail.startDays[0]);
   }, [tourDetail]);
   const placeTour = ((tourDetail.place).split(','))[0];
   // const placeTour ="";
   console.log('tourDetailId---tourDetailId: ', tourRelateDetail);
   useEffect(()=>{
      getRelateTour(
         {
            place: placeTour
                  ...
                  <div style={{ position: "sticky", top:"75px" }}>
                     ...
                     <Row style={{ background: "white", cursor: "pointer", padding: "15px" }}>
                        ...
                        <Col span={24} style={{ paddingBottom: "20px" }}>
                           <div style={{ fontSize: "26px", fontWeight: "600", color: "#ffbd00" }}>Tổng giá: {
               ...
               <Col span={24} style={{marginTop:"10px"}}>
                  ...
                  <Col span={24}>
                        ...
                        <div style={{display:"flex", flexDirection:"column", justifyContent:"center", textAlign:"center"}}>
                           <p style={{padding:0, margin:0, color:"#003C71", fontWeight:"600",paddingBottom:"5px"}}>Đánh giá bài viết</p>
                           <p>{starRating()}</p>
                        </div>
                           

                     </Col>
                     <Col span={24} style={{height:"39.2px",lineHeight:"39.2px", backgroundColor:"#f5f5f5",display:"flex", justifyContent:"space-between",
                                             border: "1px solid #ddd", padding:"0px 10px 0px 10px"}}>
                        <span style={{fontSize:"18px", cursor:"pointer", color:"#003C71", fontWeight:"500"}}>Tours du lịch Hạ Long liên quan</span>
                        <span style={{fontSize:"18px", cursor:"pointer",color:"#003C71", fontWeight:"500"}}
                           onClick={()=>{history.push(`/tours-list-relate/${placeTour}`)}}
                        >Xem tất cả</span>
                     </Col>

                     <Col span={24} style={{height:"485px", border:"1px solid #ddd", borderTop:"none", backgroundColor:"white"}}>
